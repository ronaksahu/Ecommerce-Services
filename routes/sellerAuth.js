...
authRoutes.post('/register', async (req, res) => {
    ...
    try {
        const { username, email, contactNo, password, sellerShopName, city, state, address, pinCode } = req.body;
        ...
        const user = new User({ username, email, contactNo, password, accountType: 'seller' , sellerShopName, address : { city, state, address, pinCode }});
